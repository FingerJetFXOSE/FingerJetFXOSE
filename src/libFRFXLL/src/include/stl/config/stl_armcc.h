...
# define _STLP_NATIVE_INCLUDE_PATH ../../include/windows
# define _STLP_NATIVE_C_INCLUDE_PATH ../../include/windows
# define _STLP_NATIVE_CPP_C_INCLUDE_PATH ../../include/windows
