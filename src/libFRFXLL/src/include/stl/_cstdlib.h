 ...
 * Copyright 2011 DigitalPersona, Inc.
 *
...
#  if !defined (__WATCOMC__) && \
     (!defined (_STLP_MSVC_LIB) || (_STLP_MSVC_LIB < 1310) || defined (UNDER_CE)) && !defined(_STLP_HAS_GLOBAL_C_MATH_FUNCTIONS)
...
#  if !defined (__WATCOMC__) && \
     (!defined (_STLP_MSVC_LIB) || (_STLP_MSVC_LIB < 1400) || defined (_STLP_USING_PLATFORM_SDK_COMPILER) || defined (UNDER_CE)) && !defined(_STLP_HAS_GLOBAL_C_MATH_FUNCTIONS)
...
#if defined (_STLP_LONG_LONG) && !defined(_STLP_HAS_GLOBAL_C_MATH_FUNCTIONS)
